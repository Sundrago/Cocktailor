    ...
    public class SettingsManager : MonoBehaviour
    {
        ...
        public void Start()
        {
            if (!PlayerPrefs.HasKey("resolutionDeviceType"))
            {
                ...
                else if (identifier.StartsWith("iPad")) PlayerPrefs.SetInt("resolutionDeviceType", 1);
            }
        ...
        public void ChangeResolution()
        {
            ...
            if (resolutionDropdown.value == 0)
            {
                ...
                foreach (var obj in proPreviewImages)
                    obj.GetComponent<RectTransform>().sizeDelta =
                        new Vector2(800, obj.GetComponent<RectTransform>().sizeDelta.y);
            }
            else
            {
                ...
                foreach (var obj in proPreviewImages)
                    obj.GetComponent<RectTransform>().sizeDelta =
                        new Vector2(1200, obj.GetComponent<RectTransform>().sizeDelta.y);
            }
        ...
        public void BugReport()
        {
            ...
            var email = PrivateData.DevEmail;
