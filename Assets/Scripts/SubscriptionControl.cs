...
public class SubscriptionControl : MonoBehaviour, IStoreListener
{
    ...
    //Subscription ID
    public const string productIDSubscription_month = "subscription_monthly";
    public const string productIDSubscription_year = "subscription_yearly";

    //Android ID
    private const string _Android_SubscriptionId_month = "net.sundragon.cocktail.monthly.android";
    private const string _Android_SubscriptionId_year = "net.sundragon.cocktail.yearly.android";

    //iOS ID
    private const string _IOS_SubscriptionId_month = "net.sundragon.cocktail.subscription.monthly.ios";
    private const string _IOS_SubscriptionId_year = "net.sundragon.cocktail.subscription.yearly.ios";
    ...
    public void InitializePurchasing()
    {
        ...
        builder.AddProduct(productIDSubscription_month, ProductType.Subscription, new IDs(){
            {_Android_SubscriptionId_month, GooglePlay.Name },
                        {_IOS_SubscriptionId_month, AppleAppStore.Name}
        });

        builder.AddProduct(productIDSubscription_year, ProductType.Subscription, new IDs(){
            {_Android_SubscriptionId_year, GooglePlay.Name },
                        {_IOS_SubscriptionId_year, AppleAppStore.Name}
        });
    ...
    public void OnInitialized(IStoreController controller, IExtensionProvider extension)
    {
        ...
        bool subscribed_month = IsSubscribedTo(productIDSubscription_month);
        bool subscribed_year = IsSubscribedTo(productIDSubscription_year);
    ...
    public PurchaseProcessingResult ProcessPurchase(PurchaseEventArgs args)
    {
        ...
        if (args.purchasedProduct.definition.id == productIDSubscription_month)
        {
        ...
        } else if (args.purchasedProduct.definition.id == productIDSubscription_year)
        {
    ...
    {
        Purchase(productIDSubscription_month);
    }

    public void PurchaseYear()
    {
        Purchase(productIDSubscription_year);
    }
}